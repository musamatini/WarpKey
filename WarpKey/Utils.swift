...
extension Notification.Name {
    ...
    static let permissionsRevoked = Notification.Name("permissionsRevoked")
}
...
struct AccessibilityManager {
    ...
    static func checkScreenRecordingPermissions() -> Bool {
...
class NotificationManager {
    ...
    func sendUpdateAvailableNotification(version: String) {
        let content = UNMutableNotificationContent()
        content.title = "A New WarpKey Version is Available!"
